...
var t=+new Date,r="//mp.weixin.qq.com/mp/qqmusic?action=get_song_info&song_id=#songid#";
...
var u,l=(o.ret,o.songlist[0].song_play_url),m=o.songlist[0].song_play_time||0;
o.songlist[0].playable?u=l?0:6:o.songlist[0].try_playable?o.songlist[0].try_file_size>0&&o.songlist[0].try_30s_url?(u=8,
l=o.songlist[0].try_30s_url,m=30):u=6:u=7,i({
type:"success",
time:s,
code:u
});
